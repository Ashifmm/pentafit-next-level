...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PentaFit — Personalized Fitness & Nutrition Coaching" },
      { name: "description", content: "Transform your body with PentaFit's personalized workout plans, nutrition coaching, progress tracking and 1:1 accountability. Download the app today." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "PentaFit",
          url: "/",
          description: "Personalized fitness and nutrition coaching ecosystem.",
          telephone: "+91-90745-83726",
          sameAs: [
            "https://play.google.com/store/apps/details?id=com.app.pentafit",
            "https://apps.apple.com/in/app/pentafit/id6757516669",
          ],
        }),
      },
    ],
