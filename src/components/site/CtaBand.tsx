...
export function CtaBand({
  ...
  return (
    <section className="bg-gradient-dark text-foreground">
      <div className="container-prose py-20 lg:py-28 text-center">
        ...
        <Reveal delay={120}>
          <p className="mt-5 max-w-2xl mx-auto text-lg text-foreground/80">{subtitle}</p>
        </Reveal>
        <Reveal delay={240}>
    ...
    <section className="bg-gradient-dark text-foreground">
      <div className="container-prose pt-24 pb-20 lg:pt-32 lg:pb-24">
        <Reveal>
          ...
          {subtitle && <p className="mt-5 max-w-2xl text-lg text-foreground/80">{subtitle}</p>}
        </Reveal>
      </div>
    </section>
  );
